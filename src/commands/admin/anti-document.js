...
module.exports = {
  name: "anti-documentos",
  description:
    "Activa/desactiva la función anti-documento en el grupo, eliminando el mensaje de documento si está activo.",
  commands: ["anti-documentos", "anti-doc", "anti-documento", "anti-documentos"],
  usage: `${PREFIX}anti-documentos (1/0)`,
  /**
  ...
  handle: async ({ remoteJid, isGroup, args, sendSuccessReply }) => {
    ...
    const hasActive =
      antiDocumentOn && isActiveGroupRestriction(remoteJid, "anti-documentos");

    const hasInactive =
      antiDocumentOff && !isActiveGroupRestriction(remoteJid, "anti-documentos");
    ...
    updateIsActiveGroupRestriction(remoteJid, "anti-documentos", antiDocumentOn);
